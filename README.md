...
**[Portfolio Site]** is the project whereby a Micronaut Need to setup a portfolio site to use in the future
...
Clone this repository to your desired folder:
 ...
 ```sh
  cd my-folder
  git clone git@github.com:josman227/Portfolio-Project.git
```
